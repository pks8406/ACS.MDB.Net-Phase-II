namespace ACS.MDB.Net.App.Common
{
    ...
    public class Constants
    {
        ...
        public const string DELETE_MESSAGE_FOR_MAINTENANCE_LINE = "Are you sure, you want to delete the Billing detail(s)? Billing detail(s) associated with Milestone(s) and Group will not be deleted";
        ...
        public const string DELETE_MESSAGE_FOR_RECALCULATION = "Are you sure, you want to delete the Recalculation(s)? Recalculation having status In Progress will not be deleted";
        ...
        public const string FINAL_BILLIING_INFO_REQUIRED_FOR_CREDIT_OR_ADHOC = "Please enter Final Billing Period Start Date, End Date, Amount and select Termination Reason";
        ...
        public const string FINAL_RENEWAL_START_DATE_END_DATE_AND_AMOUNT_REQUIRE = "Please enter start date, end date and amount and select termination reason for Final Billing Period";
        public const string FINAL_RENEWAL_START_DATE_AND_END_DATE_REQUIRE = "Please enter start date and end date and select Termination Reason for Final Billing Period";
        ...
        public const string FINAL_RENEWAL_START_DATE_CANNOT_BE_LESS_THAN_FIRST_PERIOD_START_DATE = "Final Billing Period Start date cannot be less than First Period Start date";
        ...
        /// <summary>
        /// User prompt message at the time of Bill To OA
        /// </summary>
        public const string INVOICE_DATE_CONFIRM_DATE = "Please confirm invoice date";
        ...
        public const string JOB_CODE_MISSING = "Job code is missing for Contract Number - ";
        
        public const string END_DATE_SHOULD_NOT_BE_MORE_THAN_FIVE_YEARS_FROM_START_DATE = "Please enter valid 'End date', It should not  be more than 5 years from Start Date";
        public const string CAN_NOT_EXPORT_THEORETICAL_REVENUE_FORECAST_REPORT = "Can not export Theoretical Revenue Forecast Report";
        public const string DATA_NOT_FOUND = "No data found";

        public const string FAILED_TO_GENERATE_OPEN_ACCOUNT_FILE =
            "The ARBS application failed to generate Open Account file. Please re-generate file.";

        public const string OPEN_ACCOUNT_LOCATION_NOT_ACCESSIBLE =
            "The Open Account file location is not accessible. Please contact to network administrator";

        /// <summary>
        /// Error message if ReleaseNotes.txt is not found
        /// </summary>
        public const string HELP_FILE_NOT_FOUND = "Help file not found";

        /// <summary>
        /// Bill to OA error log file name
        /// </summary>
        public const string BILL_TO_OA_ERROR_LOG_FILENAME = "BillToOAErrorLog";

        public const string INVALID_MILESTONE_BILL_TO_OA = "Invalid milestone(s) found. Please correct the milestone(s).";

        //public const string TWO_RECORDS_NEEDED_TO_CREATE_GROUP = "You need at least two records with the same first period start date, first renewal date, final billing period end date, charge frequency, document type, invoice in advance and its value to create a group";

        public const string TWO_RECORDS_NEEDED_TO_CREATE_GROUP = "You need at least two records with the same or anniversary of the first period start date & first renewal date, and final billing period end date, charge frequency, document type, invoice in advance and its value must be the same to create a group";

        public const string DEFAULT_LINE_LEGEND = "The highlighted line in group is the default printing line.";

        public const string UNAUTHORISED_USER = "You are not authorised user to perform this operation";

        public const string MILESTONE_MISSING = "Milestone(s) are missing for default printing line in the group. Please check Contract Number -";

        public const string FIRST_PERIOD_START_DATE_AND_FIRST_RENEWAL_DATE_SAME = "First period start date and first renewal date must be same to create a group";
