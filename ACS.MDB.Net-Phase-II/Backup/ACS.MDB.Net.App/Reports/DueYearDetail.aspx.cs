...
{
    public partial class DueYearDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    //string RevenueFromDate = Request.QueryString["RevenueFromDate"];
                    //string RevenueToDate = Request.QueryString["RevenueToDate"];

                    string ReportName = ConfigurationManager.AppSettings["DueYearDetailReport"];
                    if (ReportName != null && StartDate != null)
                    {
                        ...
                        //reportViewer.ServerReport.SetParameters(new ReportParameter[] { new ReportParameter("RevenueFromDate", RevenueFromDate) });
                       // reportViewer.ServerReport.SetParameters(new ReportParameter[] { new ReportParameter("RevenueToDate", RevenueToDate) });
